...
cur.execute('SELECT id,url FROM Pages WHERE html is NULL and error = -1 ORDER BY RANDOM() LIMIT 1')
row = cur.fetchone()
...
while True:
    ...
    try:
        ...
        if 'text/html' != document.info().get_content_type() :
            ...
            cur.execute('UPDATE Pages SET error=-1 WHERE url={0}', (url, ) )
            conn.commit()
            continue
